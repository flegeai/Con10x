...
template class Simplifications <GraphTemplate<Node_t<Kmer<32>::Type>,Edge_t<Node_t<Kmer<32>::Type > >, GraphDataVariantT>, Node_t<Kmer<32>::Type>, Edge_t<Node_t<Kmer<32>::Type > >>; 
