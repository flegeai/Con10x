...
template class Simplifications <GraphTemplate<Node_t<Kmer<128>::Type>,Edge_t<Node_t<Kmer<128>::Type > >, GraphDataVariantT>, Node_t<Kmer<128>::Type>, Edge_t<Node_t<Kmer<128>::Type > >>; 
